...
var ServerlessAppsyncPlugin = /** @class */ (function () {
    ...
    ServerlessAppsyncPlugin.prototype.getStackContainingGraphQlApi = function (stackName) {
        return __awaiter(this, void 0, void 0, function () {
            var stackContainingGraphQlApi, describeStacks, listNestedStackResources;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stackContainingGraphQlApi = stackName;
                        describeStacks = function (stackName) { return __awaiter(_this, void 0, void 0, function () {
                            var response, _i, _a, stack, found, error_1;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _b.trys.push([0, 6, , 7]);
                                        return [4 /*yield*/, this.provider.request('CloudFormation', 'describeStacks', { StackName: stackName })];
                                    case 1:
                                        response = _b.sent();
                                        if (!response.Stacks) return [3 /*break*/, 5];
                                        _i = 0, _a = response.Stacks;
                                        _b.label = 2;
                                    case 2:
                                        if (!(_i < _a.length)) return [3 /*break*/, 5];
                                        stack = _a[_i];
                                        return [4 /*yield*/, listNestedStackResources(stack.StackName)];
                                    case 3:
                                        found = _b.sent();
                                        if (found) {
                                    ...
                                    case 6:
                                        error_1 = _b.sent();
                                        this.serverless.cli.log("Error describing stack ".concat(stackName, ": ").concat(error_1.message));
                                        return [3 /*break*/, 7];
                                    case 7: return [2 /*return*/, false];
                                }
                            });
                        }); };
                        listNestedStackResources = function (stackName) { return __awaiter(_this, void 0, void 0, function () {
                            var response, _i, _a, resource, error_2;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _b.trys.push([0, 6, , 7]);
                                        return [4 /*yield*/, this.provider.request('CloudFormation', 'listStackResources', { StackName: stackName })];
                                    case 1:
                                        response = _b.sent();
                                        if (!response.StackResourceSummaries) return [3 /*break*/, 5];
                                        _i = 0, _a = response.StackResourceSummaries;
                                        _b.label = 2;
                                    case 2:
                                        if (!(_i < _a.length)) return [3 /*break*/, 5];
                                        resource = _a[_i];
                                        ...
                                        if (!(resource.ResourceType === 'AWS::CloudFormation::Stack')) return [3 /*break*/, 4];
                                        if (!resource.PhysicalResourceId) return [3 /*break*/, 4];
                                        return [4 /*yield*/, describeStacks(resource.PhysicalResourceId)];
                                    case 3:
                                        _b.sent();
                                        _b.label = 4;
                                    case 4:
                                    ...
                                    case 6:
                                        error_2 = _b.sent();
                                        this.serverless.cli.log("Error listing resources for stack ".concat(stackName, ": ").concat(error_2.message));
                                        return [3 /*break*/, 7];
                                    case 7: return [2 /*return*/, false];
                                }
                            });
                        }); };
                        return [4 /*yield*/, describeStacks(stackName)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, stackContainingGraphQlApi];
                }
            });
        });
    };
    ServerlessAppsyncPlugin.prototype.getApiId = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var logicalIdGraphQLApi, stackName, StackResources, apiId;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getStackContainingGraphQlApi(this.provider.naming.getStackName())];
                    case 1:
                        stackName = _c.sent();
    ...
    ServerlessAppsyncPlugin.prototype.createDomain = function () {
        return __awaiter(this, void 0, void 0, function () {
            var domain, certificateArn, _a, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                    ...
                    case 4:
                        ...
                        if (error_3 instanceof this.serverless.classes.Error &&
                            this.options.quiet) {
                            log_1.log.error(error_3.message);
                        }
                        else {
                            throw error_3;
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        if (error_5 instanceof this.serverless.classes.Error &&
                            error_5.providerErrorCodeExtension === 'NOT_FOUND_EXCEPTION') {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_6 = _a.sent();
                        if (error_6 instanceof this.serverless.classes.Error &&
                            this.options.quiet) {
                            log_1.log.error(error_6.message);
                        }
                        else {
                            throw error_6;
                        }
